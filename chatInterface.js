class ChatInterface {
    ...
    // 添加欢迎消息
    addWelcomeMessage() {
        this.addMessage('assistant', "Hello! I'm Bella, your AI companion. Nice to meet you! What would you like to talk about?", true);
    }
    ...
    show() {
        ...
        console.log('chatContainer computed opacity:', window.getComputedStyle(this.chatContainer).opacity);
        console.log('chatContainer computed transform:', window.getComputedStyle(this.chatContainer).transform);
